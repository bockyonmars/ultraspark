...
export default function ContactsPage() {
  ...
  async function updateStatus(id: string, status: string) {
    const updated = await api.patch<ContactMessage>(
  ...
  if (error || !data)
    return (
      <ErrorState description={error ?? "Unable to load contact messages"} />
    );
  ...
  return (
    <div className="space-y-6">
      ...
      <DetailsDrawer
        ...
        title={
          selected ? getName(selected.customer ?? undefined) : "Contact details"
        }
